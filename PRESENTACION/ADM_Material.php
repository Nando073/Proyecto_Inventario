...
<main>
  ...
  <div class="row g-0 align-items-center">
    <!-- Imagen -->
    <div class="col-5">
      <img src="../IMG/material.jpg" alt="Materiales" class="img-fluid h-100 object-fit-cover">
    </div>

    <!-- Contenido -->
    <div class="col-7 bg-light">
      <div class="card-body d-flex flex-column justify-content-center h-100 text-center p-3">
        <h4 class="card-title fw-bold" style="color: #e67e22;">Control de Materiales</h4>
        <p class="card-text text-secondary mb-0">Gestiona los materiales disponibles y su información detallada.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <form class="d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center mt-3 gap-2" action="ADM_Material.php" method="get">
        ...
        <button type="button" class="btn btn-success" id="btnCrearMaterial" data-bs-toggle="modal" data-bs-target="#materialModal">
            Registrar Material
        </button>
    </form>
